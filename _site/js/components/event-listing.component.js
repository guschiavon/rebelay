  ...
  return `
    <div class="flex flex-col gap-1 ${type.toLowerCase().split(' ').join('-')}">                                                        
      ...
      <div class="flex gap-x-1">
        <a href=${url} class="event-instance--btn bg-yellow-400 px-2 py-1 text-gray-700 border-2 border-yellow-400" target="_blank" arial-label="link opens new tab for event named ${title}">Learn More</a>
